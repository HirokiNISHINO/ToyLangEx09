...
public class Parser 
{
	 ...
	 * @throws CompileErrorException
	 */
	protected AstNode primary() throws IOException, CompileErrorException
	{
		//( expr )
		Token t = this.getCurrentToken();
		if (t.getC() == '(') {
		...
		throw new SyntaxErrorException("expected an integer literal or an identifier, but found: " + t);		
	}
